    ...
    return (
      <div>
        <Navbar className="port-navbar port-default absolute" color="transparent" light expand="md">
          <NavbarBrand className="port-navbar-brand" href="/">Luis Andia</NavbarBrand>
          ...
          <Collapse isOpen={this.state.isOpen} navbar>
            <Nav className="ml-auto" navbar>
              ...
              <NavItem className="port-navbar-item"><BsNavLink route="/portfolios" title="Portfolio"/></NavItem>
